...
class TagTestCase(APITestCase):
    ...
    def test_update_tag_by_id(self):
        ...
        #When
        response = self.admin_client.put(path=reverse("tag_detail", kwargs={"tag_id": 1}), data={"name": "update"})
    ...
    def test_update_with_invalid_user(self):
        ...
        #When
        response = self.client.put(path=reverse("tag_detail", kwargs={"tag_id": 1}), data={"name": "update"})
    ...
    def test_delete_tag_by_id(self):
        ...
        #When
        response = self.admin_client.delete(path=reverse("tag_detail", kwargs={"tag_id": 1}))
